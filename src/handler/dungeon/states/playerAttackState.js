...
import { berserkDamage, checkEnemyResist, skillEnhancement } from '../../../utils/battle/calculate.js';
...
export default class PlayerAttackState extends DungeonState {
  async enter() {
    ...
    const userDamage = userSkillInfo.damage * skillDamageRate; // 스킬 배율 /  한줄 추가 스팀팩 구현 ㄱㄱ  위험한 포션도 플러스 

    // 스팀팩 효과 적용
    const finalDamage = berserkDamage(userDamage, this.user.stat.berserk); // 스팀팩 효과에 따른 최종 대미지 계산
