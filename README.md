...
1. 이벤트 루프를 통한 비동기 I/O 처리
2. Protobuf를 활용한 역/직렬화
3. Redis를 이용한 DB 캐싱
4. MySQL 기반 관계형 데이터 관리
5. Bull을 통한 매칭 로직 동시성
  
위와 같은 사항들이 반영되어 있습니다.
...
## 기술적 도전 과제
### 모니터링 및 성능 관리
현재 **Prometheus와** **Grafana를** 통해 **CPU, 메모리, 네트워크 트래픽, DB 상태** 등의 상위 레벨 자원 사용량을 모니터링하고 있습니다.  
...
위와 목적들을 위해 커스텀 메트릭 삽입 등의 방법을 고려할 수 있을 것입니다.  
